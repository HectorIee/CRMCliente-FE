...
const ProductoResumen = ({ producto }) => {
    ...
    return (
        <div className='md:flex md:justify-between md:items-center mt-5 '>
            ...
            <input className='bg-white shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline md:ml-4'
